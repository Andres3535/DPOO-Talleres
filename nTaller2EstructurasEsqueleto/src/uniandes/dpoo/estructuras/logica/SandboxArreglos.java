...
public class SandboxArreglos
{
    ...
    public String[] getCopiaCadenas( )
    {
    	...
    	String[] CopiaCadena = new String[cantidad];
    ...
    {
    	int contador = 0;
    	while(contador < arregloEnteros.length )
    		contador ++;
        return contador;
    }
    ...
    {
    	int contador = 0;
    	while(contador < arregloCadenas.length )
    		contador ++;
        return contador;
    }
    ...
    public void eliminarEntero( int valor )
    {
    	...
    	int j = 0;
    	 for (int i1 = 0; i1 < arregloEnteros.length; i1++) {
    	        if (arregloEnteros[i1] != valor) {
    	            NuevoArreglo[j] = arregloEnteros[i1];
    	            j++;
    	        }
    	    }
    	arregloEnteros = NuevoArreglo;
    ...
    public void insertarEntero( int entero, int posicion )
    {
    	...
    	if(posicion > arregloEnteros.length -1) {
    		posicion = arregloEnteros.length -1;
    	}
